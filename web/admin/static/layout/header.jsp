...
<html>
    <head>
        ...
        <link rel="stylesheet" href="http://localhost:8080/onlinelearn/admin/static/css/header.css">
    </head>
    <body>
        <div class="header">
            <div class="header-left">
                <img src="http://localhost:8080/onlinelearn/admin/static/images/logo-white.png"/>
            </div>
