                    ...
                    <c:forEach items="${list}" var="x">
                        <div class="col-lg-3 col-md-6 col-sm-12 d-flex flex-wrap">
                            ...
                            <div class="popular-course" style="cursor: pointer">
                                <a href="CourseDetail?title=${x.title}&rate=${x.rated_star}&total_register=${x.total_register_number}&author=${x.last_name}+${x.first_name}&author_img=${x.profile_picture}">
