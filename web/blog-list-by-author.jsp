                                                    ...
                                                    <div style="display: flex;">
                                                        <div class="submit-section">
                                                            <button type="submit" class="btn btn-primary submit-btn" style="margin-right: 20px;" onclick="return confirm('Are you sure you want to delete?')">
                                                                <a href="DeleteBlog?id=${x.id}">Delete <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
                                                        ...
                                                        <div class="submit-section">
                                                            <button type="submit" class="btn btn-primary submit-btn">
                                                                <a href="EditBlog?id=${x.id}">Edit <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
