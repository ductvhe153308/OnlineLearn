                                ...
                                <c:choose>
                                    <c:when test="${sessionScope.user != null}">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <a class="btn btn-primary" style="background-color: #55acee; width: 200px" href="LessonDetail?id=${course_id}" role="button" onclick="document.getElementById('enroll').submit()">                          
                                                    <span style="display: block; font-size: 22px">
                                                        Enroll 
                                                    </span>
                                                    <span>
