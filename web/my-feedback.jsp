            ...
            <div class="container">
                ...
                <div class="row">  
                    <c:forEach items="${myfeedback}" var="x">
                        <div style="border: 1px solid black; margin-bottom: 50px; padding: 30px; display: flex; flex-direction: row; justify-content: space-between">
                            <div>
                            ...
                            <div>
                                <button type="submit" class="btn btn-primary submit-btn" style="margin-right: 20px;" onclick="return confirm('Are you sure you want to delete this feedback?')">
